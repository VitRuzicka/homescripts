...
if test -f "rp2040load" ; then 
    ...
    wget --no-check-certificate https://github.com/VitRuzicka/homescripts/raw/main/rp2040load
    chmod +x rp2040load
fi
if test -f "picotool" ; then 
    echo "picotool stažen"
else
    wget --no-check-certificate https://github.com/VitRuzicka/homescripts/raw/main/picotool
    chmod +x picotool
fi
